...
from .enhanced_codecell import EnhancedCodeCell, CellState
...
class StemCell(EnhancedCodeCell):
    ...
    def differentiate(self, target_type: Type[EnhancedCodeCell], **kwargs) -> EnhancedCodeCell:
...
class StemCellBank:
    ...
    def create_from_template(self, template_name: str, cell_name: str, **kwargs) -> Optional[EnhancedCodeCell]:
        """Template'den yeni cell oluştur"""
